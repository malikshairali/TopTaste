    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLatestOrders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                btnLatestOrders.setBackgroundColor(Color.parseColor("#eeeeee"));
                btnConfirmedOrders.setBackgroundColor(Color.parseColor("#dcdcdc"));
                fb_refLatestOrders = FirebaseDatabase.getInstance().getReference().child("Orders_HomeDelivery");
                loadOrders(fb_refLatestOrders);
                bHide = false;
            }
        ...
        btnConfirmedOrders.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btnLatestOrders.setBackgroundColor(Color.parseColor("#dcdcdc"));
                btnConfirmedOrders.setBackgroundColor(Color.parseColor("#eeeeee"));
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(Orders.this, "Permission denied to send SMS", Toast.LENGTH_SHORT).show();
                }
                return;
            }
